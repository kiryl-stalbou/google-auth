const String authFailedWebPageHtml = '''
<!DOCTYPE html>
<html class="mdl-js">
<head>
...
<div>
    <div id="app-verification-screen" class="mdl-card mdl-shadow--2dp firebase-container">
        <div id="status-container">
            <h1 class="firebase-title" id="status-container-label">Failed to verify credentials.</h1>
            <h6 class="mdl-card__subtitle-text">Please close this window, and try again.</h6>
        </div>
    </div>
</div>
</body>
...
const String authLoadingWebPageHtml = '''
<!DOCTYPE html>
...
const String authSuccessWebPageHtml = '''
<!DOCTYPE html>
<html class="mdl-js">
<head>
    <meta name="viewport" content="width=device-width, initial-scale=1">
